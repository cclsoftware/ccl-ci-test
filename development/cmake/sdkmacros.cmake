macro (add_sdk_preset preset)
	...
	if (BUILD_sdk_preset_${preset})
		...
		ExternalProject_Add (sdk-${preset}
			...
			LIST_SEPARATOR "|"
			CONFIGURE_COMMAND ${CMAKE_COMMAND} -S "${CMAKE_CURRENT_LIST_DIR}" -B "${build_dir}" --preset ${preset} -DVENDOR_ENABLE_CODESIGNING=${VENDOR_ENABLE_CODESIGNING} -DBUILD_sdk=ON -DCPACK_SYSTEM_NAME=${preset} -DVENDOR_ENABLE_PARALLEL_BUILDS=ON -DCPACK_ARCHIVE_COMPONENT_INSTALL=ON ${cmake_args}
